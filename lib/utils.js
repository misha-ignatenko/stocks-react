...
export const Utils = {
    ...
    getClosestPreviousWeekDayDateByCutoffTime: function (cutoffTime, OPTIONALrequestMomentDateTimeRightNowNyTime, format=Utils.dateFormat) {
        ...
        let _beforeCutoffTime = _timeStr < (cutoffTime || Utils.getTradingDayCutoffTime());
    ...
    ratingChanges: {
        ...
        generateAverageAnalystRatingTimeSeries: function(symbol, startDate, endDate, _allRatingChangesForSymbol) {
            ...
            _ratingChangesOfInterest = Utils.ratingChanges.excludeRatingChangesWhoseFirmsInitiatedOrSuspendedOrDroppedCoverage(_ratingChangesOfInterest);
            ...
            _result.forEach(function(res) {
                ...
                res.ratingScalesIds.forEach(function(ratingScaleId) {
                    var _rSc = Utils.ratingChanges.getRatingScaleById(ratingScaleId);
        ...
        excludeRatingChangesWhoseFirmsInitiatedOrSuspendedOrDroppedCoverage: function(ratingsChangesArray) {
            ...
            ratingsChangesArray.forEach(function(rChange) {
                var _newRScale = Utils.ratingChanges.getRatingScaleById(rChange.newRatingId);
                var _oldRScale = Utils.ratingChanges.getRatingScaleById(rChange.oldRatingId);
