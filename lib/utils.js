...
export const Utils = {
    ...
    getClosestPreviousWeekDayDateByCutoffTime: async function (cutoffTime, OPTIONALrequestMomentDateTimeRightNowNyTime, format=Utils.dateFormat) {
        ...
        let _beforeCutoffTime = _timeStr < (cutoffTime || await Utils.getTradingDayCutoffTime());
    ...
    getTradingDayCutoffTime: async function () {
        return await Utils.getSetting('clientSettings.ratingChanges.fourPmInEstTimeString');
    },
