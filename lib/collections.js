        ...
        return {
            ...
            async adjustForSplits() {
                if (!this.adjustedForSplits) {
                    ...
                    const adjustments = await ServerUtils.prices.getAllAdjustments(symbol);
            ...
            getPurchaseDate(advancePurchaseDays=0) {
                ...
                const purchaseDate = isAfterMarketClose ?
                    ...
                    Utils.businessAdd(reportDateString, -1-advancePurchaseDays);
                return purchaseDate;
            },
...
export const PortfolioPermissions = new Mongo.Collection("portfolioPermissions");
