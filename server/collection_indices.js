...
RatingChanges.createIndex({researchFirmId: 1, symbol: 1, newRatingId: 1, oldRatingId: 1, dateString: 1});
...
EarningsReleases.createIndex({reportSourceFlag: 1, reportDateNextFiscalQuarter: 1, asOf: -1});
