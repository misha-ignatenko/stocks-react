                    ...
                    <tbody>
                        {earningsReleases.map((row) => {
                            ...
                            return (
                                <tr key={rowKey}>
                                    <td>
                                        {Utils.convertToStringDate(reportDate)}
                                    </td>
                                    <td>{isAfterMarketClose ? "Yes" : "No"}</td>
                                    <td>
                                        {Utils.convertToStringDate(
                                            endDateNextFiscalQuarter,
                                        )}
                                    </td>
                                    <td>{symbol}</td>
                                    ...
                                    <td>
                                        {_.isNaN(altAvgRatingWithAdjRatings)
                                            ? null
                                            : altAvgRatingWithAdjRatings.toFixed(
                                                  2,
                                              )}
                                    </td>
                                    ...
                                    <td>
                                        {originalEpsExpectation?.toFixed(4)}
                                    </td>
                                    <td>
                                        {pctExpEpsOverOriginalEpsExpectation?.toFixed(
                                            4,
                                        )}
                                    </td>
                                    ...
                                    <td>
                                        {epsActualPreviousFiscalQuarter?.toFixed(
                                            4,
                                        )}
                                    </td>
                                    <td></td>
                                    <td>
                                        {_.isNumber(pctExpEpsOverPrevQt)
                                            ? pctExpEpsOverPrevQt.toFixed(4)
                                            : null}
                                    </td>
                                    <td>
                                        {epsActualOneYearAgoFiscalQuarter?.toFixed(
                                            4,
                                        )}
                                    </td>
                                    <td></td>
                                    <td>
                                        {_.isNumber(pctExpEpsOverOneYearAgo)
